...
class OrganizationService:
    ...
    async def organize_session_lots(
        ...
        validated_docs_db = self._db_manager.get_validated_documents(self._db_manager.session_id)
        ...
        for v_doc in validated_docs_db:
            doc = DocumentFile(
                ...
                status=DocumentStatus(v_doc.status) if v_doc.status else DocumentStatus.UNVALIDATED
            )
