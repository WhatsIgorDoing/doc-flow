...
def create_documento_rir_pdf():
    ...
    c.drawString(
        100, 710, "Código do Documento: CZ6_RNEST_U22_3.1.1.1_CVL_RIR_B-22026A"
    )
    ...
    c.drawString(
        100, 630, "O código CZ6_RNEST_U22_3.1.1.1_CVL_RIR_B-22026A deve ser extraído."
    )
...
def create_documento_rir_docx():
    ...
    doc.add_paragraph(
        "O código CZ6_RNEST_U22_3.1.1.1_CVL_RIR_B-22026A deve ser extraído."
    )
